...
SID.1st <-
  read.xlsx(
    "Stable Isotope Data - 1st Survey.xls",
    sheetIndex = 1,
    startRow = 7,
    header = T
  )
...
SID.2nd <-
  read.xlsx(
    "Stable Isotope Data - 2nd Survey.xls",
    sheetIndex = 1,
    startRow = 7,
    header = T
  )
...
SID.3rd <-
  read.xlsx(
    "Stable Isotope Data - 3rd Survey.xls",
    sheetIndex = 1,
    startRow = 7,
    header = T
  )
...
SID.4th <-
  read.xlsx(
    "Stable Isotope Data - 4th Survey.xls",
    sheetIndex = 1,
    startRow = 7,
    header = T
  )
